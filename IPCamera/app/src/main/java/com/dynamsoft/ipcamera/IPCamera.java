...
public class IPCamera extends Activity {
    ...
    private String mIP="192.168.43.5";
	...
	protected void onCreate(Bundle savedInstanceState) {
		        ...
		        public void onClick(View v) {
		          ...
		          if (mIsOn) {
		        	  if (mIP == null) {
		        		  ...
		        		  mThread = new SocketClient(mPreview, mIP, mPort,location);
		        	  }
		...
		final LocationListener mLocationListener = new LocationListener() {
			@Override
			public void onStatusChanged(String strig,int inti,Bundle bundle) {
				//your code here
			}
			@Override
			public void onLocationChanged(final Location location) {
				Log.d("IPCamera",location.getLongitude()+" - "+location.getLatitude());
				IPCamera.this.location=location;
			}
			@Override
			public void onProviderDisabled(String enable) {
				//your code here
			}
			@Override
			public void onProviderEnabled(String enable) {
				//your code here
			}
		};
